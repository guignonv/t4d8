...
/**
 * Plugin implementation of the 'stock_reference_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "stock_reference_formatter",
 *   label = @Translation("Stock prop formatter type"),
 *   field_types = {
 *     "stock_reference"
 *   }
 * )
 */
class StockReferenceFormatter extends StockReferenceFormatterBase {
  ...
  protected function viewValue(FieldItemInterface $item) {
    return nl2br(Html::escape($item->object_id . ' (type ' . $item->type_id . ')'));
  }
