...
namespace Drupal\stockref_field\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'stockref_widget_type' widget.
 *
 * @FieldWidget(
 *   id = "stock_reference_autocomplete",
 *   module = "stockref_field",
 *   label = @Translation("Stock reference widget"),
 *   field_types = {
 *     "stock_reference"
 *   }
 * )
 */
class StockReferenceAutocompleteWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    $element += [
      '#type' => 'fieldset',
      '#title' => $this->t('Stock relationships'),
    ];
    ...
    $element['type_id'] = [
      ...
      '#required' => TRUE,
      '#description' => $this->t('CV term identifier (cvterm_id) defining the type of this relationship.'),
    ];
    ...
    $element['value'] = [
      ...
      '#placeholder' => $this->getSetting('placeholder'),
      '#required' => FALSE,
      '#description' => $this->t('Value relative to the relationship.'),
    ];
    ...
    $element['rank'] = [
      ...
      '#required' => FALSE,
      '#description' => $this->t('Rank used to sort relationships.'),
    ];
